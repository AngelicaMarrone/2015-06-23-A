...
public class MusicController {
    ...
    void doDistanza(ActionEvent event) {
    	...
    	int peso= model.creaGrafo();
    	txtResult.appendText("La distanza massima è "+peso);
    }
    ...
    void doElenco(ActionEvent event) {
    	...
    	if (m==null)
    	{txtResult.appendText("ERRORE: seleziona mese\n");
    	return;}
    	
    	String ris= model.trovaElenco(m.getValue());
